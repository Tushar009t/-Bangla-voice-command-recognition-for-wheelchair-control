function [x_cropped, Fs, t_cropped] = audio_length_crop(file_name, time_period)

[x_,Fs] = audioread(file_name);          % reading audio file
...
% plot(t, x)
% 
% %plot new cropped audio
% figure(2)
% plot(t_cropped, x_cropped)
