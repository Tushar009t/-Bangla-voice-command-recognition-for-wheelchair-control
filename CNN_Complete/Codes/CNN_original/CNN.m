...
dataFolder = fullfile('E:\Current Projects\EEE 312 Project\CNN\CNN_Complete','sized_dataset');
...
recordblocking(recObj,1.9);
disp('End of Recording.');

x_real = getaudiodata(recObj);
sound(x_real,fs)
auditorySpect = helperExtractAuditoryFeatures(x_real,fs);
auditorySpect_cropped = auditorySpect(1:198,:);
